...
;
     ...
     readraw,configvars,raw,scan_index,sweep_count,transition_flag,elevation,azimuth,n_blocks,n_pol,scatvars,filename,file_header_size,$
...
;
     ...
     compute_range_profiles,range_gate_spacing,n_blocks,n_pol,ngates,gate_offset,gate_plot_max,elevation,azimuth,scan_index,$
